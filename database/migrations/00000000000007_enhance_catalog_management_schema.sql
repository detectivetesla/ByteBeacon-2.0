-- ==============================================================================
-- Migration: 00000000000007_enhance_catalog_management_schema.sql
-- Description: Multi-Tier Pricing, Provider Mappings, Visibility Flags, Price Audit Trail & Provider Sync Batches
-- Invariant: Minor Units (Ghanaian Pesewas BIGINT), Authoritative Server Pricing, DataHouse Fulfillment Authority
-- ==============================================================================
