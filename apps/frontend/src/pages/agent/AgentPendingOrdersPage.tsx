...
export type PendingMtnApprovalItem = CustomerPendingApprovalItem;
...
export const AgentPendingOrdersPage: React.FC = () => {
  ...
  const handlePrecheckNewNumber = async () => {
    ...
    try {
      ...
      // Explicitly record check to increment database attempt_count / occurrences
              ...
              <div style={{ display: 'flex', gap: '0.4rem', flexWrap: 'wrap' }}>
                ...
                <Button
                  ...
                  onClick={() => {
                    ...
                    navigate(`/agent/buy-data?network=${selectedRecord.network}&phone=${encodeURIComponent(selectedRecord.phoneNumber)}`);
                  }}
