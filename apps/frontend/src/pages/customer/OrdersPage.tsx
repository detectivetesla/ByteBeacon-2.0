...
export const OrdersPage: React.FC = () => {
  ...
  return (
    <div style={{ maxWidth: '1280px', margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
      ...
      <Card style={{ padding: 'var(--space-4)', backgroundColor: 'var(--color-bg-surface-elevated)', border: '1px solid var(--color-border-subtle)' }}>
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem', alignItems: 'center', flex: 1 }}>
            ...
            <div className="desktop-only" style={{ display: 'flex', gap: '0.35rem', backgroundColor: 'var(--color-bg-base)', padding: '2px', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-border-subtle)' }}>
              {[
                { label: 'All', value: 'ALL' },
      ...
      {/* 4. Single Authoritative Order History Section */}
      <section style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
        ...
        {filteredOrders.length === 0 ? (
          ...
          <>
            {/* Desktop Table View */}
            <div className="desktop-only" style={{ overflowX: 'auto', backgroundColor: 'var(--color-bg-surface)', borderRadius: 'var(--radius-xl)', border: '1px solid var(--color-border-default)' }}>
            ...
            {/* Mobile Responsive Order Row Transformation */}
              ...
              {paginatedOrders.map((order) => (
                ...
                >
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                      <NetworkBadge network={order.network} size="sm" />
                      <strong style={{ fontSize: 'var(--font-size-sm)', fontFamily: 'var(--font-data)', color: 'var(--color-text-primary)' }}>
                        {order.dataDisplay}
                      </strong>
                    </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-2)', borderTop: '1px solid var(--color-border-subtle)', paddingTop: 'var(--space-2)' }}>
                    <div>
                      <span style={{ fontSize: 'var(--font-size-3xs)', color: 'var(--color-text-muted)', textTransform: 'uppercase', fontWeight: 800 }}>
                        Paid
                      </span>
                      <div style={{ fontSize: 'var(--font-size-sm)', fontWeight: 800, fontFamily: 'var(--font-data)', color: 'var(--color-text-primary)' }}>
                        {order.paidDisplay || order.amountDisplay}
                      </div>
                    </div>
                    <div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: 'var(--font-size-2xs)', color: 'var(--color-text-muted)', borderTop: '1px solid var(--color-border-subtle)', paddingTop: 'var(--space-2)' }}>
                    <span>{order.dateDisplay}</span>
                    <span style={{ color: 'var(--color-brand)', fontWeight: 700 }}>View details →</span>
                  </div>
                </Card>
              ))}
            </div>
