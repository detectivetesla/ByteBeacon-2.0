...
import { Database, RefreshCw, DollarSign, ShieldCheck, CreditCard, Layers } from 'lucide-react';
    ...
    <div style={{ maxWidth: '1300px', margin: '0 auto', width: '100%', display: 'flex', flexDirection: 'column', gap: 'var(--space-6)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 'var(--space-4)' }}>
        ...
        <MetricCard
          ...
          accent="purple"
          icon={<TactileIcon icon={Layers} color="api" size="sm" />}
        />
        <MetricCard
      ...
      {/* Filter Bar */}
      <Card accentColor="green" style={{ padding: 'var(--space-4)' }}>
