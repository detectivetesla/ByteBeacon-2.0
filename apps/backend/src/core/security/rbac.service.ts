...
> = {
  ...
  [Permission.WEBHOOKS_READ]: {
    category: PermissionCategory.DEVELOPER_APIS,
    name: 'Read Webhooks',
    description: 'View partner and agent webhook subscriptions, delivery URLs, and event filters.',
    riskLevel: ConfigRiskLevel.LOW,
    requiresStepUp: false,
  },
  [Permission.WEBHOOKS_WRITE]: {
    category: PermissionCategory.DEVELOPER_APIS,
    name: 'Write Webhooks',
    description: 'Create, rotate signing secrets, and delete partner and agent webhook subscriptions.',
    riskLevel: ConfigRiskLevel.MEDIUM,
    requiresStepUp: false,
  },
  [Permission.SANDBOX_MANAGE]: {
