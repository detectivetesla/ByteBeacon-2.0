...
export async function adminSettingsRoutes(
  ...
  app.put<{
    ...
    async (req, reply) => {
      ...
      // If maintenance_mode was updated, synchronize with platform_feature_flags & safety controls
  ...
  app.put<{
    ...
    async (req, reply) => {
      ...
      // If MAINTENANCE_MODE was toggled, mirror into system_configurations & safety tables
