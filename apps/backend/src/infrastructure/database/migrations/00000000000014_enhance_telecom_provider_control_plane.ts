...
export const migration00000000000014: MigrationFile = {
  version: '00000000000014',
  name: 'enhance_telecom_provider_control_plane',
  upSql: `
  ...
  `,
  downSql: `
    DROP TABLE IF EXISTS provider_incidents CASCADE;
    ...
    DROP TABLE IF EXISTS telecom_providers CASCADE;
    DROP TABLE IF EXISTS telecom_networks CASCADE;
  `,
};
