...
export const migration00000000000033: MigrationFile = {
  version: '00000000000033',
  name: 'create_agent_applications_schema',
  upSql: `
  ...
  downSql: `
    ...
    DELETE FROM system_configurations WHERE config_key = 'agent_application_fee_pesewas';
  `,
};
