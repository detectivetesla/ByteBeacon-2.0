...
export const migration00000000000010: MigrationFile = {
  version: '00000000000010',
  name: 'enhance_api_management_and_security_schema',
  upSql: `
  ...
  `,
  downSql: `
    DROP TABLE IF EXISTS provider_switch_logs CASCADE;
    DROP TABLE IF EXISTS telecom_provider_configs CASCADE;
    DROP TABLE IF EXISTS webhook_delivery_logs CASCADE;
    DROP TABLE IF EXISTS agent_webhooks CASCADE;
    DROP TABLE IF EXISTS api_security_events CASCADE;
    DROP TABLE IF EXISTS api_usage_metrics CASCADE;
    DROP TABLE IF EXISTS api_policy_controls CASCADE;
  `,
};
