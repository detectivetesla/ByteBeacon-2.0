...
export function createApp(options: AppOptions = {}) {
  ...
  const emailService = options.emailService ?? getEmailService();
  ...
  app.register(
    async (commerceSubApp: FastifyInstance) => {
      ...
      await adminApiManagementRoutes(commerceSubApp, {
        db: dbPool!,
        apiKeyService,
        tokenService,
        rbacService,
      ...
      await adminAuditSecurityRoutes(commerceSubApp, {
        db: dbPool!,
        apiKeyService,
        tokenService,
        rbacService,
      ...
      await adminNotificationsRoutes(commerceSubApp, {
        db: dbPool!,
        apiKeyService,
        tokenService,
        rbacService,
      ...
      await adminAlertsRoutes(commerceSubApp, {
        db: dbPool!,
        apiKeyService,
        tokenService,
        rbacService,
