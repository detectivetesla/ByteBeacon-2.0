...
export enum PermissionCategory {
  ORDERS = 'ORDERS',
  WALLET_FINANCE = 'WALLET_FINANCE',
  USERS_AGENTS = 'USERS_AGENTS',
  CATALOG_TELECOM = 'CATALOG_TELECOM',
...
// =========================================================================
// Phase 11.15: Notifications, Alerts & System Communications Enums
// =========================================================================
...
export enum NotificationType {
  ...
  ACCOUNT_SECURITY_CHANGE = 'ACCOUNT_SECURITY_CHANGE',
  // Agent notifications
  STORE_APPROVED = 'STORE_APPROVED',
  STORE_REJECTED = 'STORE_REJECTED',
  STORE_PAYOUT_UPDATE = 'STORE_PAYOUT_UPDATE',
  NEW_CUSTOMER_ORDER = 'NEW_CUSTOMER_ORDER',
  API_KEY_EVENT = 'API_KEY_EVENT',
  API_USAGE_WARNING = 'API_USAGE_WARNING',
  MTN_APPROVAL_UPDATE = 'MTN_APPROVAL_UPDATE',
  AGENT_WALLET_EVENT = 'AGENT_WALLET_EVENT',
  // Admin notifications
  NEW_USER_REGISTRATION = 'NEW_USER_REGISTRATION',
  NEW_AGENT_APPLICATION = 'NEW_AGENT_APPLICATION',
  NEW_STORE_APPLICATION = 'NEW_STORE_APPLICATION',
  LARGE_TRANSACTION = 'LARGE_TRANSACTION',
  FAILED_PAYMENT = 'FAILED_PAYMENT',
  FAILED_FULFILLMENT = 'FAILED_FULFILLMENT',
  RECONCILIATION_DISCREPANCY = 'RECONCILIATION_DISCREPANCY',
  PROVIDER_OUTAGE = 'PROVIDER_OUTAGE',
  QUEUE_DLQ_GROWTH = 'QUEUE_DLQ_GROWTH',
  ...
  PAYMENT_PROVIDER_ISSUE = 'PAYMENT_PROVIDER_ISSUE',
  TELECOM_SYNC_ISSUE = 'TELECOM_SYNC_ISSUE',
  DATABASE_HEALTH_ISSUE = 'DATABASE_HEALTH_ISSUE',
